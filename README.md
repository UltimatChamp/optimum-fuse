...
1. **`<loader>`:** **Values:** `fabric`, `quilt`, `neo` or `forge`.
...
**Note:** The _older versions_ of the project didn't use **semantic versioning**. **Semantic versioning** has been adopted, since versions: `1.7.3+fabric.1.20.4` and `1.5.0+neo`<small>(forge)</small>`.1.20.1`.
...
This has been implemented _after_ versions: `1.7.3+fabric.1.20.4` and `1.5.0+neo`<small>(forge)</small>`.1.20.1`.
