...
You can also add resource-packs, data-packs and shaders, in-game, by click on the `➕` button in their respective menus.
</Callout>
...
- Close the screen, and click on `➕ Install Content`.
